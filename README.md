...
Market Review Pro 是一个基于 OpenClaw 平台的自动化市场复盘报告生成技能。它能够自动采集全球市场数据（A股、港股、美股、日韩），生成结构化、数据驱动、**基金从业人员风格**的深度复盘报告。

> 📊 "基金从业人员风格" = 专业、审慎、结构严谨、数据驱动、有明确投资指引的机构研报口吻
...
| 📈 **VIX 恐慌指数** | 五维分析模型（当前值/历史分位/形态/期权信号/观察要点） |
| 💰 **板块资金流向** | 精确到小数点后两位，全市场 + 行业板块双维度 |
| 🔥 **热点主题挖掘** | TOP5 热点事件，含催化剂、市场反应、机构点评 |
| 🏆 **涨停连板追踪** | 连板梯队、封板率、晋级率 |
...
```
1. 📊 市场整体表现概览        — 六大指数对比表
1.5 📉 VIX 恐慌指数分析       — 五维模型 + 观察要点 + 仓位对照表
2. 💰 板块资金流入流出详情     — TOP5 流入/流出 + 机构点评
...
> - **📋 机构点评：** "AI算力板块今日表现强劲，资金流入集中度高。基本面角度看，行业景气度持续，建议关注龙头标的的中期配置价值，同时注意短期估值修复后的获利了结压力。"

> **VIX 观察要点：**
> - VIX < 15：市场过于乐观，宜保持审慎，逐步兑现收益
> - VIX 15-25：正常波动区间，维持中性仓位，灵活应对
> - VIX > 25：恐慌情绪升温，可适度加仓优质资产，注意止损纪律
